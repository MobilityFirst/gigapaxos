...
java -ea -Xms4096M -cp $CLASSPATH -DgigapaxosConfig=$1 -DtestingConfig=$2 -Djava.util.logging.config.file=logging.properties edu.umass.cs.gigapaxos.testing.TESTPaxosMain -c 2>$LOGFILE
